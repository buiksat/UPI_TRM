...
runner and an immutable disjoint train/validation/test corpus now exist, but a
compatible successful persistent checkpoint is still missing. The bridge and
common-pool matched comparison are also missing. Until
