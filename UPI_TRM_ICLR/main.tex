...
runner now exists, but recovering or replacing the missing persistent
checkpoints and hard held-out manifest is required before it can produce a
learned-model result. The bridge and common-pool matched comparison are also missing. Until
