...
exact baseline summation, complete $K$-step segments with terminal masking,
and explicit-mixture collection. Its bootstrap still came from an EMA target
rather than the frozen current evaluator. Its endpoint evaluator scored only
...
the nominal outer-step-20,000 endpoint over seeds 41--50. This is an
...
formulas. Its registered run has 26,686 passing assertions, including
